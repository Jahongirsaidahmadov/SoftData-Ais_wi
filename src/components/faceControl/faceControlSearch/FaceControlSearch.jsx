            ...
            <div className="face_control_search">
                <div className="face_control_search_header">
                    <div className="content_top">
                        <p className={`Content_title ${isDarkMode && 'darkModeColor'}`}>Face Control Qidiruv</p>
                    </div>
                          ...
                          <div className="face_control_search_inline_inputs">
                            ...
                            <div className="form_input_wrapper">
                                ...
                                <div className="input_wrapper face_search_inputs">
                                    ...
                                    >
                                        <Select.Option value="all">Hammasi</Select.Option>
                                        {/*<Select.Option value="1">Kulgan</Select.Option>*/}
                                        {/*<Select.Option value="2">E'tiborsiz</Select.Option>*/}
                                        {/*<Select.Option value="3">Baqirgan</Select.Option>*/}
                                        {/*<Select.Option value="4">Ikkilangan</Select.Option>*/}
